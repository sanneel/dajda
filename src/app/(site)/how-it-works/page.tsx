 ...
 */
/*
 * Built per request, not at import: the renewal sentence depends on
 * SUBSCRIPTION_RECURRING and a build has no env to read it from.
 */
function sections(recurring: boolean) {
  return [
    {
      id: 'record',
    ...
    },
    {
      ...
      body: [
        ...
        'დაჯდა თუ არ დაჯდა, ამას ადმინი წყვეტს სკრინშოტის შემოწმების შემდეგ. თუ შედეგის სკრინშოტი არ არის, ადმინი ხელით ამოწმებს.',
      ],
    },
    {
      id: 'free',
    ...
    {
      id: 'follow',
      question: 'რას მაძლევს Follow?',
      body: [
        'ავტორის გვერდზე Follow-ს დაჭერით მის ყოველ ახალ ბილეთზე მიიღებთ შეტყობინებას მეილზე ან ტელეგრამზე - ტელეგრამი პარამეტრებში ერთი ღილაკით უკავშირდება.',
        'ზედა ზოლის ზარში კი ყოველთვის ჩანს Follow-ში მყოფი ავტორების ჯერ დაუთვლელი ბილეთები; შედეგის დაფიქსირებისთანავე ჩანაწერი ზარიდან ქრება.',
      ],
    },
    {
      id: 'money',
      ...
      body: [
        ...
        recurring
          ? 'გამოწერა ღირს 30, 40 ან 50 ლარი თვეში, ფასს ავტორი ირჩევს. გადახდა ხსნის ერთი თვის წვდომას და გამოწერა ავტომატურად განახლდება ყოველთვიურად: ბარათიდან იმავე თანხა ჩამოიჭრება, სანამ არ გააუქმებთ. გაუქმება ნებისმიერ დროს შეგიძლიათ პროფილის გვერდიდან, და წვდომა გადახდილი პერიოდის ბოლომდე რჩება.'
          : 'გამოწერა ღირს 30, 40 ან 50 ლარი თვეში, ფასს ავტორი ირჩევს. გადახდა ხსნის ერთი თვის წვდომას და ავტომატურად არ განახლდება: ბარათიდან თანხა ხელახლა არ ჩამოიჭრება, და გასაგრძელებლად ვადის ბოლოს გადაიხდით ხელახლა.',
        'ფასიანი ბილეთი ცალკე იყიდება: ავტორი თითო ბილეთს თავის ფასს ადებს და შეძენა ხსნის მხოლოდ იმ ერთ ბილეთს, მხოლოდ მყიდველისთვის. გამოწერა მას არ მოიცავს, გამოწერა სააბონენტო ბილეთებს ხსნის.',
        'პლატფორმაზე არანაირი ბალანსი არ ინახება: არც შესავსები ანგარიში, არც ფსონი, არც მოგება. თითოეული შენაძენი ცალკე გადახდაა ბარათით.',
      ],
    },
  ];
}
