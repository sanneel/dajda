...
const SECTIONS = [
  {
    ...
    body: [
      'ყველა ავტორზე ჩანს ROI, სიზუსტე, პროგნოზების რაოდენობა და შედეგი ერთეულებში. ციფრები ითვლება მხოლოდ გამოქვეყნებული და დასრულებული პროგნოზებიდან; ხელით არაფერი იწერება.',
  ...
  },
  {
    ...
    body: [
      ...
      'ასეთი პროგნოზი არავის სტატისტიკაში არ ითვლება: ის არც სიზუსტეზე მოქმედებს და არც ROI-ზე. მხოლოდ ანალიტიკოსის ფსონები ქმნის მის ჩანაწერს.',
    ],
  },
  {
    id: 'live',
