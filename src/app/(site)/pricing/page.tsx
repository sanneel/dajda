...
const PRODUCTS: {
...
}[] = [
  {
    ...
    description: [
      ...
      'გამოწერა ცალკე გაყიდულ ბილეთებს არ მოიცავს: ისინი ცალკე იყიდება და მხოლოდ მყიდველისთვის იხსნება. გამოწერა განახლდება ავტომატურად ყოველი თვის ბოლოს; გაუქმება შესაძლებელია ნებისმიერ დროს პროფილიდან, წვდომა რჩება გადახდილი პერიოდის ბოლომდე.',
    ],
  },
  {
    id: 'ticket',
