...
const TERMS: Clause[] = [
  ...
  },
  {
    ...
    items: [
      'პლატფორმაზე ავტორად რეგისტრაცია ავტომატური არ არის. კანდიდატი წარადგენს განაცხადს, რომელშიც უთითებს სახელს, გვარს, რეფერალს, სპორტის ძირითად მიმართულებას და ეთანხმება წინამდებარე წესებს.',
      'განაცხადს ხელით განიხილავს პლატფორმის ადმინისტრაცია. დაშვების ან უარის შესახებ გადაწყვეტილება ფიქსირდება სისტემაში.',
      'ავტორი ვალდებულია გამოწერის მოქმედების პერიოდში რეგულარულად მიაწოდოს გამომწერებს კონტენტი. ამ ვალდებულების დარღვევა წარმოადგენს ავტორის სტატუსის შეჩერების და მომხმარებლისთვის თანხის დაბრუნების საფუძველს.',
    ],
  },
  {
