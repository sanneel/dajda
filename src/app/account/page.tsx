 ...
 * browse it.
 *
 * Settings is no longer separate either. It held one editable field, an
 * email that cannot be edited, five switches, a Telegram link and the way
 * out - not a page's worth, and being a page is what made a phone unable to
 * reach half of it. The three tabs below are the account's three questions:
 * what do I have, how should it behave, and how do I get in and out.
 */
